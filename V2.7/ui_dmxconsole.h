...
public:
    ...
    void setupUi(QDialog *DMXconsole)
    {
        if (DMXconsole->objectName().isEmpty())
            DMXconsole->setObjectName(QStringLiteral("DMXconsole"));
        ...
        BtnStartStreaming->setObjectName(QStringLiteral("BtnStartStreaming"));
        ...
        sl_virtualH->setObjectName(QStringLiteral("sl_virtualH"));
        ...
        chk_SelectAll->setObjectName(QStringLiteral("chk_SelectAll"));
    ...
    {
        DMXconsole->setWindowTitle(QApplication::translate("DMXconsole", "Dialog", 0));
        groupBox->setTitle(QApplication::translate("DMXconsole", "512 DMX channels", 0));
        grp_index1->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value1->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index4->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value4->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index2->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value2->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index5->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value5->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index3->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value3->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index0->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value0->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index9->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value9->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index8->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value8->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index10->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value10->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index7->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value7->setText(QApplication::translate("DMXconsole", "0", 0));
        grp_index6->setTitle(QApplication::translate("DMXconsole", "GroupBox", 0));
        lb_value6->setText(QApplication::translate("DMXconsole", "0", 0));
        BtnStartStreaming->setText(QApplication::translate("DMXconsole", "DMX stream ON", 0));
        chk_SelectAll->setText(QApplication::translate("DMXconsole", "Select All channels", 0));
    } // retranslateUi
