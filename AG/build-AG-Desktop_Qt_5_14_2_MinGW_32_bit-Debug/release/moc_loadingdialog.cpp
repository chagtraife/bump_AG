...
QT_MOC_LITERAL(1, 14, 26), // "signal_close_loadingdialog"
...
QT_MOC_LITERAL(5, 66, 5) // "event"
    ...
    "LoadingDialog\0signal_close_loadingdialog\0"
...
void LoadingDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_close_loadingdialog(); break;
        ...
        {
            using _t = void (LoadingDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoadingDialog::signal_close_loadingdialog)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoadingDialog::signal_close_loadingdialog()
{
