...
QT_RGB_DMX_LIB::qtdmxlib::qtdmxlib()
{

}

QT_RGB_DMX_LIB::DMXRDM::DMXRDM()
{
    timer = new QTimer();
...
void QT_RGB_DMX_LIB::DMXRDM::RDMRecHandler(QByteArray data)
{
    quint16 check_sum = 0;
    quint8 RDM_size;
...
void QT_RGB_DMX_LIB::DMXRDM::GetDeviceInfo()
{
    QByteArray data;
    data.resize(1);
    data[0] = 1;
...
void QT_RGB_DMX_LIB::DMXRDM::setUID(QString newUID)
{
    int count = 0, pos = 0;
    do
    {
...
void QT_RGB_DMX_LIB::DMXRDM::setUID(QByteArray newUID)
{
...
bool QT_RGB_DMX_LIB::DMXRDM::isRecRDM()
{
    return  _isRecRDM;
}

void QT_RGB_DMX_LIB::DMXRDM::setDMXID(quint16 DMXID)
{
    QByteArray temp;
    temp.resize(3);
    temp[0] = 1;
...
void QT_RGB_DMX_LIB::DMXRDM::setDMXUID(QString sUID)
{
    int count = 0, pos = 0;
    do
    {
...
void QT_RGB_DMX_LIB::DMXRDM::setLever(quint8 max, quint8 min)
{
    QByteArray data;
    data.resize(2);
    data[0] = (char) max;
...
void QT_RGB_DMX_LIB::DMXRDM::updateFirmware()
{
...
void QT_RGB_DMX_LIB::DMXRDM::delay(unsigned long ms)
{
    QEventLoop loop;
...
void QT_RGB_DMX_LIB::DMXRDM::scanDev()
{
    QByteArray data;
    data.resize(0);
    //data[0] = 1;
...
bool QT_RGB_DMX_LIB::DMXRDM::askDMXAdd()
{
    QByteArray gUID, data_temp;
    data_temp[0] = 0;
    rdm_cmd = cmd_AskDMXSlot;
...
bool QT_RGB_DMX_LIB::DMXRDM::RDMPing()
{
    QByteArray data;
    data.resize(1);
    data[0] = 1;
...
bool QT_RGB_DMX_LIB::DMXRDM::askDeviceType()
{
    QByteArray data;
    data.resize(1);
    data[0] = 1;
...
bool QT_RGB_DMX_LIB::DMXRDM::askThreshold()
{
    QByteArray data;
    data.resize(1);
    data[0] = 1;
...
bool QT_RGB_DMX_LIB::DMXRDM::askFwV()
{
    QByteArray data;
    data.resize(1);
    data[0] = 1;
...
bool QT_RGB_DMX_LIB::DMXRDM::askSEQAddress()
{
    QByteArray gUID, data_temp;
    data_temp[0] = 0;
    rdm_cmd = cmd_GetSEQAddress;
...
bool QT_RGB_DMX_LIB::DMXRDM::askEPROM()
{
    QByteArray gUID, data_temp;
    data_temp[0] = 0;
...
void QT_RGB_DMX_LIB::DMXRDM::writeEEprom(quint8 *eeprom)
{
    QByteArray data;
    data.resize(10);
...
void QT_RGB_DMX_LIB::DMXRDM::setAdmin(QString Pw)
{
    if(Pw == sPW)
    {
        _isUser = true;
...
bool QT_RGB_DMX_LIB::DMXRDM::isAdmin()
{
    return _isUser;
}

void QT_RGB_DMX_LIB::DMXRDM::timer_pw()
{
...
QByteArray QT_RGB_DMX_LIB::DMXRDM::MakeDataSend(QByteArray UID, DMXRDM::RDM_CMD cmd, QByteArray data)
{
    _isRecRDM = false;
...
bool QT_RGB_DMX_LIB::DMXRDM::askChannel_RGB_old()
{
...
quint16 QT_RGB_DMX_LIB::DMXRDM::readChannl_RBB_old()
{
    return ChannelLEDOld;
}

bool QT_RGB_DMX_LIB::DMXRDM::writeChannel_RGB_old(quint16 channel)
{
    QByteArray data_send;
...
void QT_RGB_DMX_LIB::DMXRDM::writeChannel_RGB_old_Loop(quint16 channel)
{
    QByteArray data_send;
    data_send.resize(12);
...
QT_RGB_DMX_LIB::UID::UID()
{
    bUID.clear();
    sUID = "";
}

QT_RGB_DMX_LIB::UID::UID(QString UID)
{
    sUID = UID;
    bUID.clear();
}

QT_RGB_DMX_LIB::UID::UID(quint8 UID1, quint8 UID2, quint8 UID3, quint8 UID4, quint8 UID5, quint8 UID6)
{
    bUID.resize(6);
    bUID[0] = (char) UID1;
    bUID[1] = (char) UID2;
...
QT_RGB_DMX_LIB::UID::UID(QByteArray UID)
{
    bUID = UID;
}

QString QT_RGB_DMX_LIB::UID::toString()
{
    sUID = "";
    if(bUID.size())
    {
...
QByteArray QT_RGB_DMX_LIB::UID::toQByteArray()
{
...
QT_RGB_DMX_LIB::DeviceInfo::DeviceInfo()
{

}

QString QT_RGB_DMX_LIB::DeviceInfo::GetDeviceTypeName(uint8_t DevType)
{
...
QString QT_RGB_DMX_LIB::DeviceInfo::GetFirmwareName(uint8_t FWVersion)
{
    QString s;
...
QString QT_RGB_DMX_LIB::DeviceInfo::sEEprom()
{
...
bool QT_RGB_DMX_LIB::DeviceInfo::setEEprom(QString s)
{
    int count = 0, pos = 0;
    do
    {
